...
\@x{\@s{9.58} {\p@fair} {\p@process} {\p@lparen} n \.{\in} Nodes {\p@rparen}}%
 \@x{\@s{9.58} {\p@variable} v \.{=} 0 ,\, pv \.{=} 0 ,\, Q \.{=} \{ \}
 {\p@semicolon}}%
\@x{\@s{9.58} {\p@lbrace}}%
...
\@pvspace{8.0pt}%
 \@x{\@s{9.58} PS\@s{.5}\textrm{:}\@s{3}\@s{12.29} {\p@while} {\p@lparen} up [
 self ] \.{\land} Q \.{\neq} \{ \} {\p@rparen} {\p@lbrace}}%
\@x{\@s{49.96} {\p@with} {\p@lparen} p \.{\in} Q {\p@rparen} {\p@lbrace}}%
\@x{\@s{58.16}}%
\@y{\@s{0}%
 Node can fail here, such that \ensuremath{up[self]} will be set to False
}%
\@xx{}%
\@x{\@s{58.16}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{58.16} MayBeFail ( ) {\p@semicolon}}%
\@x{\@s{58.16}}%
\@y{\@s{0}%
 Pop process \ensuremath{p} from \ensuremath{Q
}}%
\@xx{}%
\@x{\@s{58.16} Q \.{:=} Q \.{\,\backslash\,} \{ p \} {\p@semicolon}}%
\@x{\@s{58.16} {\p@if} {\p@lparen} up [ self ] {\p@rparen} {\p@lbrace}}%
 \@x{\@s{77.01} mb [ p ] \.{:=} mb [ p ] \.{\cup} \{ v \}
 {\p@semicolon}\@s{4.1}}%
\@y{\@s{0}%
 Broadcast value of self to each process if self is up
}%
\@xx{}%
\@x{\@s{58.16} {\p@rbrace}}%
\@x{\@s{49.96} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{41.76} {\p@rbrace} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{41.76}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{41.76} MayBeFail ( ) {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{34.18}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{42.62} {\p@if} {\p@lparen} up [ self ] {\p@rparen} {\p@lbrace}}%
\@x{\@s{61.47} pt [ self ] \.{:=} pt [ self ] \.{+} 1 {\p@semicolon}}%
\@x{\@s{42.62} {\p@rbrace} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{42.62}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{9.58} PR\@s{.5}\textrm{:}\@s{3}\@s{12.30} {\p@await} ( up [ self ]
 \.{=} {\FALSE} \.{\lor} ( up [ self ] \.{\land} ( \A\, i \.{\in} Nodes \.{:}
 {\IF} up [ i ] \.{\THEN} pt [ i ] \.{=} pt [ self ] \.{\ELSE} {\TRUE} ) ) )
 {\p@semicolon}}%
\@y{\@s{0}%
 agreement property is that two variables cannot
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\@s{42.62}}%
...
\@xx{}%
\@x{\@s{42.62} {\p@if} {\p@lparen} up [ self ] {\p@rparen} {\p@lbrace}}%
\@x{\@s{61.47} d [ self ] \.{:=} SetMin ( mb [ self ] ) {\p@semicolon}}%
\@x{\@s{61.47} t [ self ]\@s{1.87} \.{:=} {\TRUE} {\p@semicolon}}%
\@x{\@s{42.62} {\p@rbrace}}%
...
\@x{\@s{57.56} \.{\land} {\IF} up [ self ]}%
 ...
 \@x{\@s{112.13} \.{\land} t \.{'}\@s{1.87} \.{=} [ t {\EXCEPT} {\bang} [ self
 ]\@s{1.87} \.{=} {\TRUE} ]}%
\@x{\@s{80.82} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{112.13} \.{\land} {\UNCHANGED} {\langle} t ,\, d {\rangle}}%
...
\@y{\@s{0}%
 ...
 \ensuremath{{\TRUE}}) otherwise it has not terminated
}%
\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
Explanation:
 Agreement Property: The nodes that have terminated (up nodes) have the same
 decision values
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
- The agreement property is satisfied when \ensuremath{FAILNUM\.{=}0
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 We take 3 \ensuremath{Nodes} in the system and check for
 \ensuremath{FAILNUM\.{=}1} ie 1 node crashes out of the 3 nodes.
 In this scenario the final state at which the \ensuremath{Agreement}
 Invariant is violated is:
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} FailNum \.{=} 0
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} Q \.{=} {\langle}\{3\},\, \{\},\, \{\}{\rangle}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} d \.{=} {\langle}\.{-}1,\, 1,\, 2{\rangle}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\land} mb \.{=} {\langle}\{2,\, 3\},\, \{1,\, 2,\, 3\},\,
 \{2,\, 3\}{\rangle}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\land} pc \.{=} {\langle}\@w{PS},\, \@w{Done},\,
 \@w{Done}{\rangle}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} pt \.{=} {\langle}0,\, 1,\, 1{\rangle}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} pv \.{=} {\langle}0,\, 0,\, 0{\rangle}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} t \.{=} {\langle}{\FALSE},\, {\TRUE},\, {\TRUE}{\rangle}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\land} up \.{=} {\langle}{\FALSE},\, {\TRUE},\,
 {\TRUE}{\rangle}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} v \.{=} {\langle}1,\, 2,\, 3{\rangle}
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 1. In this scenario, when Node 1 fails, it was able to broadcast its value to
 Node 2 but not to Node 3.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 2. Node 2 \ensuremath{terminates(t\.{=}{\TRUE})} with minimum value 1, which
 was sent by Node 1 (its decision is 1).
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 3. Node 3 \ensuremath{terminates(t\.{=}{\TRUE})} with minimum value 2 (its
 decision is 2).
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 4. Since both have different decision values at termination, it violates the
 \ensuremath{Agreement} property.
\end{cpar}%
\begin{cpar}{0}{T}{T}{0}{2.5}{%
5.}%
 Note that Node 1 fails, and we do not set its \ensuremath{t[1]} to
 \ensuremath{{\TRUE}}. It remains \ensuremath{{\FALSE}} as initially set.
